    ...
    <script>
        ...
        $(function (){
            $("#dl").click(function (){
                ...
                $.post("gamesuserloginservlet",$("#loginform").serialize(),function (data){
                    if(data.flag){
                        //登录成功
                        alert("登录成功！")
                        location.href="gameusersystem.html";
                    }else{
                        //登陆失败
                        alert("登录失败！用户名或密码错误")
...
<div id="out">
    <form id="loginform" name="loginform" action="gamesuserloginservlet">
        <table >
